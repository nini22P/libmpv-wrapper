...
pub struct Libmpv {
    ...
    pub mpv_client_api_version: Result<
        unsafe extern "C" fn() -> ::std::os::raw::c_ulong,
        ::libloading::Error,
    >,
    pub mpv_error_string: Result<
        unsafe extern "C" fn(
    ...
    pub mpv_free: Result<
        ...
        ::libloading::Error,
    >,
    pub mpv_client_name: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle) -> *const ::std::os::raw::c_char,
        ::libloading::Error,
    >,
    pub mpv_client_id: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle) -> i64,
        ::libloading::Error,
    >,
    pub mpv_create: Result<
        unsafe extern "C" fn() -> *mut mpv_handle,
        ::libloading::Error,
    >,
    pub mpv_initialize: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle) -> ::std::os::raw::c_int,
        ::libloading::Error,
    >,
    pub mpv_destroy: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle),
        ::libloading::Error,
    >,
    pub mpv_terminate_destroy: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle),
        ::libloading::Error,
    >,
    pub mpv_create_client: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
        ) -> *mut mpv_handle,
        ::libloading::Error,
    >,
    pub mpv_create_weak_client: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
        ) -> *mut mpv_handle,
        ::libloading::Error,
    >,
    pub mpv_load_config_file: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
        ...
        ::libloading::Error,
    >,
    pub mpv_get_time_ns: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle) -> i64,
        ::libloading::Error,
    >,
    pub mpv_get_time_us: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle) -> i64,
        ::libloading::Error,
    >,
    pub mpv_free_node_contents: Result<
        unsafe extern "C" fn(node: *mut mpv_node),
        ::libloading::Error,
    >,
    pub mpv_set_option: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
            format: mpv_format,
        ...
        ::libloading::Error,
    >,
    pub mpv_set_option_string: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
    ...
    pub mpv_command_async: Result<
        ...
        ::libloading::Error,
    >,
    pub mpv_command_node_async: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            reply_userdata: u64,
            args: *mut mpv_node,
        ...
        ::libloading::Error,
    >,
    pub mpv_abort_async_command: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle, reply_userdata: u64),
        ::libloading::Error,
    >,
    pub mpv_set_property: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
            format: mpv_format,
        ...
        ::libloading::Error,
    >,
    pub mpv_set_property_string: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
            data: *const ::std::os::raw::c_char,
    ...
    pub mpv_del_property: Result<
        ...
        ::libloading::Error,
    >,
    pub mpv_set_property_async: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            reply_userdata: u64,
            name: *const ::std::os::raw::c_char,
    ...
    pub mpv_get_property: Result<
        ...
        ::libloading::Error,
    >,
    pub mpv_get_property_string: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
        ...
        ::libloading::Error,
    >,
    pub mpv_get_property_osd_string: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            name: *const ::std::os::raw::c_char,
        ) -> *mut ::std::os::raw::c_char,
        ::libloading::Error,
    >,
    pub mpv_get_property_async: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            reply_userdata: u64,
            name: *const ::std::os::raw::c_char,
        ...
        ::libloading::Error,
    >,
    pub mpv_observe_property: Result<
        unsafe extern "C" fn(
            mpv: *mut mpv_handle,
            reply_userdata: u64,
            name: *const ::std::os::raw::c_char,
        ...
        ::libloading::Error,
    >,
    pub mpv_unobserve_property: Result<
        unsafe extern "C" fn(
            mpv: *mut mpv_handle,
        ...
        ::libloading::Error,
    >,
    pub mpv_event_name: Result<
        unsafe extern "C" fn(event: mpv_event_id) -> *const ::std::os::raw::c_char,
        ::libloading::Error,
    >,
    pub mpv_event_to_node: Result<
        unsafe extern "C" fn(
            dst: *mut mpv_node,
            src: *mut mpv_event,
        ) -> ::std::os::raw::c_int,
    ...
    pub mpv_request_event: Result<
        ...
        ::libloading::Error,
    >,
    pub mpv_request_log_messages: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
        ...
        ::libloading::Error,
    >,
    pub mpv_wait_event: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle, timeout: f64) -> *mut mpv_event,
        ::libloading::Error,
    >,
    pub mpv_wakeup: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle),
        ::libloading::Error,
    >,
    pub mpv_set_wakeup_callback: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            cb: ::std::option::Option<
                unsafe extern "C" fn(d: *mut ::std::os::raw::c_void),
            >,
            d: *mut ::std::os::raw::c_void,
        ),
        ::libloading::Error,
    >,
    pub mpv_wait_async_requests: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle),
        ::libloading::Error,
    >,
    pub mpv_hook_add: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
            reply_userdata: u64,
            name: *const ::std::os::raw::c_char,
        ...
        ::libloading::Error,
    >,
    pub mpv_hook_continue: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle, id: u64) -> ::std::os::raw::c_int,
        ::libloading::Error,
    >,
    pub mpv_get_wakeup_pipe: Result<
        unsafe extern "C" fn(ctx: *mut mpv_handle) -> ::std::os::raw::c_int,
        ::libloading::Error,
    >,
    pub mpv_render_context_create: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub mpv_render_context_set_parameter: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub mpv_render_context_get_info: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_render_context,
            param: mpv_render_param,
        ) -> ::std::os::raw::c_int,
        ::libloading::Error,
    >,
    pub mpv_render_context_set_update_callback: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_render_context,
        ...
        ::libloading::Error,
    >,
    pub mpv_render_context_update: Result<
        unsafe extern "C" fn(ctx: *mut mpv_render_context) -> u64,
        ::libloading::Error,
    >,
    pub mpv_render_context_render: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_render_context,
            params: *mut mpv_render_param,
        ) -> ::std::os::raw::c_int,
        ::libloading::Error,
    >,
    pub mpv_render_context_report_swap: Result<
        unsafe extern "C" fn(ctx: *mut mpv_render_context),
        ::libloading::Error,
    >,
    pub mpv_render_context_free: Result<
        unsafe extern "C" fn(ctx: *mut mpv_render_context),
        ::libloading::Error,
    >,
    pub mpv_stream_cb_add_ro: Result<
        unsafe extern "C" fn(
            ctx: *mut mpv_handle,
...
impl Libmpv {
 ...
 @return A static string describing the error. The string is completely
    ...
    pub unsafe fn mpv_error_string(
        &self,
        error: ::std::os::raw::c_int,
    ) -> *const ::std::os::raw::c_char {
        unsafe {
 ...
 @return a new handle, or NULL on error*/
    pub unsafe fn mpv_create_client(
        &self,
        ctx: *mut mpv_handle,
        name: *const ::std::os::raw::c_char,
    ) -> *mut mpv_handle {
 ...
 mpv_handle will block until all weak mpv_handles are destroyed.*/
    pub unsafe fn mpv_create_weak_client(
        &self,
        ctx: *mut mpv_handle,
        name: *const ::std::os::raw::c_char,
    ) -> *mut mpv_handle {
 ...
 This also has OSD and string expansion enabled by default.*/
    pub unsafe fn mpv_command_string(
        &self,
        ctx: *mut mpv_handle,
        args: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int {
 ...
 @param reply_userdata ID of the request to be aborted (see above)*/
    pub unsafe fn mpv_abort_async_command(
        &self,
        ctx: *mut mpv_handle,
        reply_userdata: u64,
    ) {
 ...
 @param name The property name. See input.rst for a list of properties.
 @return error code*/
    pub unsafe fn mpv_del_property(
        &self,
        ctx: *mut mpv_handle,
        name: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int {
 ...
 *dst may point to newly allocated memory, or pointers in mpv_event. You must
 ...
 @return error code (MPV_ERROR_NOMEM only, if at all)*/
    pub unsafe fn mpv_event_to_node(
        &self,
        dst: *mut mpv_node,
        src: *mut mpv_event,
    ) -> ::std::os::raw::c_int {
 ...
 @return error code*/
    pub unsafe fn mpv_hook_continue(
        &self,
        ctx: *mut mpv_handle,
        id: u64,
    ) -> ::std::os::raw::c_int {
 ...
 @return A UNIX FD of the read end of the wakeup pipe, or -1 on error.
    ...
    pub unsafe fn mpv_get_wakeup_pipe(
        &self,
        ctx: *mut mpv_handle,
    ) -> ::std::os::raw::c_int {
        unsafe {
 ...
 @return error code. If a parameter could actually be changed, this returns
         ...
         and situation.*/
    pub unsafe fn mpv_render_context_set_parameter(
        &self,
        ctx: *mut mpv_render_context,
        param: mpv_render_param,
    ) -> ::std::os::raw::c_int {
 ...
 @return error code. If a parameter could actually be retrieved, this returns
    ...
    pub unsafe fn mpv_render_context_get_info(
        &self,
        ctx: *mut mpv_render_context,
        param: mpv_render_param,
    ) -> ::std::os::raw::c_int {
 ...
 @param callback_ctx opaque argument to the callback*/
    pub unsafe fn mpv_render_context_set_update_callback(
        &self,
        ctx: *mut mpv_render_context,
        callback: mpv_render_update_fn,
        callback_ctx: *mut ::std::os::raw::c_void,
 ...
 @param user_data opaque pointer passed into the mpv_stream_cb_open_fn
                  callback.
 @return error code*/
    pub unsafe fn mpv_stream_cb_add_ro(
        &self,
        ctx: *mut mpv_handle,
        protocol: *const ::std::os::raw::c_char,
        user_data: *mut ::std::os::raw::c_void,
